...
def bezier_get_t(x, p0, p1, p2, p3, tolerance=1e-6):
    t_min, t_max = 0.0, 1.0
...
def bezier_get_y(x, p0, p1, tolerance=1e-6):
    t = bezier_get_t(x, (0,0), p0, p1, (1,1), tolerance)
    y = bezier(t, (0,0), p0, p1, (1,1))[1]
    return y