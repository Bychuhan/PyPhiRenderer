...
TEXT = [
    ...
    [Text("null",font), [130, 555], 0.5, [0, 0.5], [0, 0, 0], "1"],
    [Text("难度",font), [40, 490], 0.5, [0, 0.5], [1, 1, 1], "1"],
    [Text("null",font), [130, 490], 0.5, [0, 0.5], [0, 0, 0], "1"],
    [Text("窗口宽度",font), [40, 230], 0.5, [0, 0.5], [1, 1, 1], "1"],#425
    [Text("窗口高度",font), [40, 165], 0.5, [0, 0.5], [1, 1, 1], "1"],#360
    [Text("1200",font), [205, 230], 0.5, [0, 0.5], [0, 0, 0], "1"],
    [Text("900",font), [205, 165], 0.5, [0, 0.5], [0, 0, 0], "1"],
    [Text("曲师",font), [40, 425], 0.5, [0, 0.5], [1, 1, 1], "1"],#295
    [Text("null",font), [130, 425], 0.5, [0, 0.5], [0, 0, 0], "1"],
    [Text("谱师",font), [40, 360], 0.5, [0, 0.5], [1, 1, 1], "1"],
    [Text("null",font), [130, 360], 0.5, [0, 0.5], [0, 0, 0], "1"],#230
    [Text("画师",font), [40, 295], 0.5, [0, 0.5], [1, 1, 1], "1"],
    [Text("null",font), [130, 295], 0.5, [0, 0.5], [0, 0, 0], "1"],#165
...
class InputBoard:
    ...
    def s_width(self):
        if TEXT[self.text_index][0].w * TEXT[self.text_index][2] > self.xmax:
            TEXT[self.text_index][2] = self.s / (TEXT[self.text_index][0].w * self.s / self.xmax)
            self.width = self.xmax + 5
        else:
            TEXT[self.text_index][2] = self.s
...
while True:
    ...
    for event in pygame.event.get():
        #tips.append(Tip(str(event), (0, 1, 0), (1, 1, 1), (1, 1, 1), 0.2))
